    `v 28 [
        ...
        `synonyms [
            `term { iast="arjunaḥ uvāca" } `meaning [Arjuna said]
            `term { iast="dṛṣṭvā" } `meaning [after seeing]
            `term { iast="imam" } `meaning [all these]
            `term { iast="sva-janam" } `meaning [kinsmen]
            `term { iast="kṛṣṇa" } `meaning [O Kṛṣṇa]
            `term { iast="yuyutsum" } `meaning [all in a fighting spirit]
            `term { iast="samupasthitam" } `meaning [present]
            `term { iast="sīdanti" } `meaning [are quivering]
            `term { iast="mama" } `meaning [my]
            `term { iast="gātrāṇi" } `meaning [limbs of the body]
            `term { iast="mukham" } `meaning [mouth]
            `term { iast="ca" } `meaning [also]
            `term { iast="pariśuṣyati" } `meaning [is drying up.]
        ]
        `translation [
        ...
        `purport [
            ...
            *yasyāsti bhaktir bhagavaty akiñcanā  
            ...
            “One who has unflinching devotion for the Personality of Godhead has all the good qualities of the demigods. But one who is not a devotee of the Lord has only material qualifications that are of little value. This is because he is hovering on the mental plane and is certain to be attracted by the glaring material energy.” ([*Bhāg.* 5.18.12](/en/library/sb/5/18/12/))
        ]
    ]
