    `v 78 [
        ...
        `synonyms [
            `term { iast="yatra" } `meaning [where]
            `term { iast="yoga-īśvaraḥ" } `meaning [the master of mysticism]
            `term { iast="kṛṣṇaḥ" } `meaning [Lord Kṛṣṇa]
            `term { iast="yatra" } `meaning [where]
            `term { iast="pārthaḥ" } `meaning [the son of Pṛthā]
            `term { iast="dhanuḥ-dharaḥ" } `meaning [the carrier of the bow and arrow]
            `term { iast="tatra" } `meaning [there]
            `term { iast="śrīḥ" } `meaning [opulence]
            `term { iast="vijayaḥ" } `meaning [victory]
            `term { iast="bhūtiḥ" } `meaning [exceptional power]
            `term { iast="dhruvā" } `meaning [certain]
            `term { iast="nītiḥ" } `meaning [morality]
            `term { iast="matiḥ mama" } `meaning [my opinion.]
        ]
        `translation [
